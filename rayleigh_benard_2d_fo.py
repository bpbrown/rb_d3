...
problem.add_equation("dt(b) + dot(u, grad(b0)) - kappa*div(grad_b) + lift(tau2b,-1) = - dot(u,grad(b))")
problem.add_equation("dt(u) + τ_drag*u - nu*div(grad_u) + grad(p) + lift(tau2u,-1) - b*ez = -skew(grid(u))*div(skew(u))")
